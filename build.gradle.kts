...
publishing {
    ...
    repositories {
        maven {
            ...
            name = "GitHubPackages"
            // 仓库 github URL
            url = uri("https://maven.pkg.github.com/shilic/numeric-converter")
            // 设置仓库凭证
            credentials {
    ...
    publications {
        ...
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description = "数值转换器"
                url.set("https://github.com/shilic/numeric-converter")
                licenses {
                    license {
                ...
                scm {
                    connection.set("scm:git:git://github.com/shilic/numeric-converter.git")
                    developerConnection.set("scm:git:ssh://github.com/shilic/numeric-converter.git")
                    url.set("https://github.com/shilic/numeric-converter")
                }
            }
        }
